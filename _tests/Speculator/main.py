...
def get_args():
    ...
    parser.add_argument('-pn', '--partition', default=12, type=int,
    ...
    parser.add_argument('-d', '--delta', default=20, type=int,
    ...
    parser.add_argument('--proba', default=True, action='store_true',
                        help='Display probabilities of the predicted trend')
    parser.add_argument('--proba_log', default=True, action='store_true',
